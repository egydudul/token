...
class LINE extends LineAPI {
    ...
    poll(operation) {
     ...
     {
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Woooiii!!! Jangan Main Kick Sembarangan!!! Aku Kick Kamu Yaa, Byeee!!!"
this._client.sendMessage(0,egyq);
     }
            // op1 = group nya
            // op2 = yang 'nge' kick
            // op3 = yang 'di' kick
...
if(operation.type == 11) { //bukattupQR
     {
let egyuye = new Message();
egyuye.to = operation.param1;
egyuye.text = "Jangan Ubah Gambar Dan Nama Group/Jangan Dimainin QR-nya -__- Aku Kick Yaa !"+"Cuma Admin Yang Bisa!!!"
this._client.sendMessage(0,egyuye);
     }
            if(!this.isAdminOrBot(operation.param2)){
                this._kickMember(operation.param1,[operation.param2]);
            } 
...
let egyuye = new Message();
egyuye.to = operation.param1;
egyuye.text = "Byee~Byee... Jangan Balek Lagi Yaa Ke Group... Bikin Semak Aja... Makasih ^_^"
...
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Terima Kasih Telah Invite Saya Di Group Anda ^_^\n\nSilahkan Ketik [/eGy] Untuk Mengetahui Command Bot Kami.\n\n~eGy~"
,"Invite Juga eGy II Kesini ^_^"

this._client.sendMessage(0,egyq);
}
{
let egy = new Message();
egy.to = operation.param1;
egy.text = "Invite Juga eGy II Kesini ^_^"

this._client.sendMessage(0,egy);
  }
}
...
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Hallo Selamat Datang ^_^ Jangan Nakal Yaa Di Group Ini ^_^"
...
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Kok Dibatalin? Emangnya Dia Siapa?"
...
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Thx For Add Me 😘 Invite Me To Your Group ^_^"
this._client.sendMessage(0,egyq);
}
...
let egyq = new Message();
egyq.to = operation.param1;
egyq.text = "Jangan Main Invite Sembarangan... Siapa Tau Kicker 😧"
...
this.command('Halo', ['halo disini eGy','kamu siapa?']);
this.command('Hi', ['hi disini eGu','kamu siapa?']);

this.command('eGy', ['Apa kak? ada yg bisa dibantu?','Ketik /eGy untuk bantuan']);
...
this.command('Bot', ['apa kak manggil2 aku?','ketik /eGy untuk bantuan']);
...
this.command('halo', ['halo disini eGy','kamu siapa?']);
this.command('hi', ['hi disini eGy','kamu siapa?']);
